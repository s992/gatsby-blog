    ...
    <div className="row">
      ...
      <div className="col-md-8 col-lg-7 col-xl-5 center-block">
        ...
        <p>
          ...
          language or toolset. I'm currently working with TypeScript, Objective-C, and Java, but I'll always continue to
          dabble in other technologies.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <span>LinkedIn: </span>
            <a href="https://linkedin.com/pub/sean-walsh/bb/aa4/6a8">https://linkedin.com/pub/sean-walsh/bb/aa4/6a8</a>
          </li>
        </ul>
      </div>
    </div>
